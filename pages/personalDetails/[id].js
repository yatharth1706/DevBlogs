...
const PersonalDetails = () => {
  ...
  const saveAllUserDataToFirestore = (url) => {
    const toStore = {
      ...
      profilePic: url
        ? url
        : "https://www.google.com/url?sa=i&url=https%3A%2F%2Fsupport.mozilla.org%2Fen-US%2Fkb%2Frefresh-firefox-reset-add-ons-and-settings&psig=AOvVaw1WmR0kELmDMmPGaoWmTwti&ust=1632721194491000&source=images&cd=vfe&ved=0CAsQjRxqFwoTCPCWv8z2m_MCFQAAAAAdAAAAABAD",
        ...
        <Card.Body className="d-flex" style={{ flexDirection: "column" }}>
          ...
          >
            ...
            <FormControl
              ...
              className="mb-3"
              style={{ boxShadow: "0 0 0 1px lightgray" }}
              id="profilePicFile"
          ...
          <Form style={{ width: "100%" }} onSubmit={savePersonalDetails}>
            ...
            <Button type="submit" style={{ backgroundColor: "#5952cb" }} className="w-100">
              Continue
            </Button>
          </Form>
        </Card.Body>
